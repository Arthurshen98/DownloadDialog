package com.arthur.dialoglibrary.load;
...
import com.arthur.dialoglibrary.R;
...
public class RingProgressBar extends View {
  ...
  public RingProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    ringColor = mTypedArray.getColor(R.styleable.RingProgressBar_ring_Color, Color.BLACK);
    ringProgressColor = mTypedArray.getColor(R.styleable.RingProgressBar_ring_ProgressColor,
        Color.WHITE);
    textColor = mTypedArray.getColor(R.styleable.RingProgressBar_ring_textColor, Color.BLACK);
    textSize = mTypedArray.getDimension(R.styleable.RingProgressBar_ring_textSize, 16);
    ringWidth = mTypedArray.getDimension(R.styleable.RingProgressBar_ring_Width, 5);
    max = mTypedArray.getInteger(R.styleable.RingProgressBar_ring_max, 100);
    textIsShow = mTypedArray.getBoolean(R.styleable.RingProgressBar_ring_textIsShow, true);
    style = mTypedArray.getInt(R.styleable.RingProgressBar_ring_style, 0);
